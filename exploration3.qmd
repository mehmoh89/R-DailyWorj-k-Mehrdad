...
small_dat <- small_dat |> tidyr::drop_na(Politystand2014, CBINDEX)
...
mod1 <- loess(Politystand2014~CBINDEX,span=res2$par,deg=1,family="symmetric",data=dat)
```
